         ...
         <div className="intro_box_main mt-5 max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 px-4 py-5">
           ...
           <div className="intro_box flex flex-wrap items-center">
             ...
             style={{ transition: 'transform 0.3s ease-in-out' }}>
               <div className="header relative">
               <div className="icon-area">
                 <Image src={combo} width={407} height={300} alt="Combo Paan" />
               </div>
...
// import { FaGrinStars } from "react-icons/fa";
// import "/src/components/productsection.css";
...
//         <link
//           href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400..700&family=Playwrite+CU:wght@100..400&display=swap" rel="stylesheet"
//         />
//       </Head>
